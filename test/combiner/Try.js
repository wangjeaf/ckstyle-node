...
function _do_border() {
    ...
    equal(msg, '.a{border:1px solid red}.b{border:1px red}.c,.d{border:1px solid}.e{border:medium solid red}.f{border-color:red}.g{border:1px solid;*border-color:red}.h{border:2px}.i{border:11px}', 'just border compress ok')
}