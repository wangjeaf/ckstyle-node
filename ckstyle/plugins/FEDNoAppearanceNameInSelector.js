...
var existsAppearanceWords = require('./helper').existsAppearanceWords;
...
module.exports = global.FEDDoNotSetStyleForTagOnly = new Class(RuleSetChecker, function () {
        ...
        var word = existsAppearanceWords(selector);
		
        if(word!==null){
            self.errorMsg =util.format(self.errorMsg_origin,word)  //注意兼容性
            return false
		}
        ...
        "desc":"避免将在selector中出现 <code>.red</code> <code>.left</code> 等描述性词汇，用具体的实际意义来代替，比如 <code>.error</code> <code>.sidebar</code> "
    }
	})