...
module.exports = global.FEDReplaceBorderZeroWithBorderNone = new Class(RuleChecker, function () {
		...
		this.check = function (self, rule, config) {
			...
			if (rule.name == 'border-width' && rule.value == '0') {
		...
		this.__doc__ = {
			...
			"desc" : "<code>border:0</code> 实际上是有border的，只不过宽度为0， 而 <code>border:none;</code> 是根本没有border的，对于浏览器来说后者的效率高，但是要注意，后者的代码长度稍微长一些。"
		}
	})